...
export const DEFAULT_HUNT_ID = DEFAULT_EVENT_ID.replace("texas-sandfest-", "sculpture-passport-");

export function normalizeHunt(raw = {}) {
  return {
    id: raw.id ?? DEFAULT_HUNT_ID,
...
export function normalizeCheckpoint(raw = {}) {
  ...
  return {
    id: raw.id ?? null,
    huntId: raw.huntId ?? DEFAULT_HUNT_ID,
...
export function progressForAttendee(checkpoints = [], completions = [], attendeeRef, huntId = DEFAULT_HUNT_ID) {
...
export function checkpointsFromSculptors(sculptorsDoc = {}, { huntId = DEFAULT_HUNT_ID } = {}) {
