...
function approvalTimestamp(value, errors, nowMs) {
  ...
  if (!normalized || !TIMEZONE_PATTERN.test(normalized) || !Number.isFinite(timestamp)) {
    errors.push("CAMERA_MODEL_APPROVED_AT must be an ISO-8601 timestamp with a timezone.");
