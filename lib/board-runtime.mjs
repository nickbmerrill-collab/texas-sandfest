...
export const BOARD_RUNTIME_SCHEMA_VERSION = 6;
...
function partnerDemo(eventId, now, { messageMode = "review_first", publicSiteUrl = "http://127.0.0.1:5175", partnerPortalSecret = null } = {}) {
  ...
  const portalToken = issuePartnerPortalToken(sponsor.application, { config: portalConfig });
  doc = requireResult(updatePartnerDeliverable(doc, sponsorProof.id, {
    ...
    ...options,
    actorId: "sponsor-demo",
    portalUrl: partnerPortalUrl(sponsor.application, portalToken, { config: portalConfig })
