...
export const BOARD_RUNTIME_SCHEMA_VERSION = 2;
...
export async function prepareBoardRuntime({ sourceRoot, targetRoot, eventId, now = new Date().toISOString(), replace = false, messageMode = "review_first" } = {}) {
