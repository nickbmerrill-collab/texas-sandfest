...
const DOC_KEYS = {
  ...
  sculptorRoster: "sculptor-roster",
...
export function platformDocumentFilePath(root, key) {
  const map = {
    ...
    budgetControl: ["data", "processed", "budget-control.json"],
    ...
    sculptorRoster: ["data", "processed", "sculptor-roster.json"],
    ...
    guestServices: ["data", "processed", "guest-services.json"],
...
export function platformDocumentStorageKey(key) {
  return documentKeyFor(key);
}
