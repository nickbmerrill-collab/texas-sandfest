...
export function updatePartnerContactPreference(docInput, applicationId, input, options = {}) {
  ...
  const dismissibleStatuses = new Set(["pending", "draft_ready", "approved", "queued", "sending", "failed"]);
...
export function generateDueTaskFollowups(docInput, options = {}) {
  ...
  const activeFollowupStatuses = new Set(["pending", "draft_ready", "approved", "queued", "sending", "failed"]);
  const generated = [];
