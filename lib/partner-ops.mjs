...
export function updateOutreachCampaignStatus(docInput, campaignId, action, options = {}) {
  ...
  return {
    ...
    doc: {
      ...
      campaigns,
      followups,
      activity: [...doc.activity, activity(idFactory, `outreach.campaign.${action}`, "campaign", campaignId, now, options.actorId ?? "admin", { returnedToReview, dismissedFollowups, failedHeldForRetry })].slice(-1000)
    }
  };
}
