...
export const CURRENT_EVENT_OPERATIONAL_DOCUMENT_KEYS = Object.freeze([
  "fleet",
  "budgetControl",
  "volunteers",
  "staffDirectory",
...
export function operationalDocumentEventId(key, document) {
  if (key === "sculptorRoster") return document?.meta?.eventId ?? null;
  if (key === "passportHunt") return document?.hunt?.eventId ?? null;
  return document?.eventId ?? null;
}
