...
export function taskPortalSafeHash(hash) {
  return String(hash || "").startsWith("#task-status?") ? "#task-status" : null;
}
...
export const shouldForgetTaskPortalAccess = shouldForgetPartnerPortalAccess;
