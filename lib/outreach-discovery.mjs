...
const FIXTURE_CANDIDATES = [
  {
    ...
    contactEmail: "partnerships@seabreeze-resort.example.com",
    industry: "lodging",
    city: "Port Aransas",
    state: "TX",
    postalCode: "78373",
  ...
  },
  {
    ...
    contactEmail: "community@island-harbor-bank.example.com",
    industry: "financial",
    city: "Port Aransas",
    state: "TX",
    postalCode: "78373",
  ...
  },
  {
    ...
    contactEmail: "community@coastal-build-supply.example.com",
    industry: "retail",
    city: "Aransas Pass",
    state: "TX",
    postalCode: "78336",
