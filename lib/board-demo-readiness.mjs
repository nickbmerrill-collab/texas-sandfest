...
export function evaluateBoardDemoReadiness(state = {}) {
  ...
  const checks = [
    ...
    check("operations", "Seeded operations", operationsReady, operationsReady ? `${applicationSummary.total} applications, all ${staffDirectory.totalTeams} team routes, and the extracted board briefing are ready.` : "The board runtime is missing partner records, staff routes, local email readiness, or the extracted board briefing.", "Rebuild with npm run board:runtime and restart the API."),
