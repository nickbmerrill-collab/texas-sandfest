...
export async function verifyLiveDeployment({
  ...
  add("api.sponsor_tiers", "api", sponsors.response?.status === 200 && Array.isArray(sponsors.json?.sponsorPackages) && sponsors.json.sponsorPackages.length > 0, `${sponsors.json?.sponsorPackages?.length || 0} sponsor packages.`);
