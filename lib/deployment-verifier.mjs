...
export async function verifyLiveDeployment({
  ...
  const [publicPage, publicWorker, publicStaticBootstrap, publicMediaManifest, appleAssociation, adminPage, health, ready, apiBootstrap, tickets, sponsors, vendors, island, concierge, publicCors, adminCors] = requests;
