...
const TOPICS = [
  ...
  ["vendor", ["vendor application", "vendor fee", "food vendor", "vendor", "booth", "sell at", "food truck"]],
...
function vendorAnswer(context) {
  ...
  return result(`Current vendor offerings include ${labels.join("; ")}. Food and non-food applicants can use the vendor application in the Sponsors and vendors section; every application remains subject to review.`, "vendor", {
    sources: [source("vendor-offerings", "Current vendor offerings", "#sponsors", vendorData.lastUpdated), guideSource(guide)],
    suggestions: ["Where is the vendor application?", "What sponsorship packages are open?", "How do I contact SandFest?"]
  });
}
...
function escalationAnswer(topic, context) {
  ...
  const label = {
    parking: "A reviewed parking or shuttle plan is not available in the current public feed.",
    accessibility: "Detailed accessibility and accommodation guidance is not available in the current public feed.",
