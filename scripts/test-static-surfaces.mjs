...
assert(visitorSource.includes('href="mailto:sponsors@texassandfest.org"')
  && visitorSource.includes('href="mailto:vendors@texassandfest.org"')
  && visitorSource.includes('["loading", "checking"].includes(unavailableState)'), "Unavailable partner intake does not provide category-specific contact fallbacks after readiness resolves.");
