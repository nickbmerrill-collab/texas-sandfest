...
assert(vercelConfig.buildCommand === "node scripts/verify-vercel-project.mjs && npm run build:public", "Vercel PR previews must verify project isolation and build only the public surface.");
