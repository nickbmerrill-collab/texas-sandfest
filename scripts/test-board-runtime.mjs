...
try {
  ...
  check("board runtime publishes only approved sponsor branding", publicSponsorCatalog.status === 200 && publicBoardSponsor?.packageName === "Marlin" && publicBoardSponsor?.tagline === "Rooted on the Texas coast" && publicBoardSponsor?.website === null && publicBoardSponsor?.primaryColor === "#006B63" && publicBoardSponsor?.secondaryColor === "#F4B942" && publicBoardSponsor?.logo?.path === "/api/public/sponsor-showcase/assets/demo_brand_asset_gulf_shore_primary" && publicBoardSponsor?.logo?.contentType === "image/png");
